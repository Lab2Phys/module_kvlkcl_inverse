            ...
            try:
                ...
                if sign_choice == 'both':
                    ...
                    with PdfPages(pdf_filename) as pdf:
                        ...
                        e_pos = find_unknown_voltage(n1, n2, v_magnitude, **calc_args)
                        ...
                        e_neg = find_unknown_voltage(n1, n2, -v_magnitude, **calc_args)
                    ...
                    e_result = find_unknown_voltage(n1, n2, signed_voltage, **calc_args)
